...
const { addOrderItems, getOrderById, getOrderTracking, resumeOrderPayment, getMyOrders, getAllOrders, updateOrderStatus, generatePayuHash, handlePayuSuccess, handlePayuFailure } = require('../controllers/orderController');
...
router.get('/track/:id', optionalAuth, getOrderTracking);
router.get('/:id/pay', optionalAuth, resumeOrderPayment);
